# Experiment wih different ranges and slices to get a feel for how they work.
# Remembrt that you can print the range as well as iterating through it to print
