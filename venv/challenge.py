# Create a program that taken an IP address entered at the keyboard
...
# 255
#
# So your program should work even with invalid IP Adresses. We'r just interested in the
