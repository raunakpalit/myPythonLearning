...
#
# Hint: change the number of iterations to 1000 or 10000. The default
# of one million will take long time to run.
...
if __name__ == "__main__":
    ...
    print(timeit.repeat("x = fact(130)", setup="from __main__ import fact", number=1000))
    print(timeit.repeat("x = factorial(130)", setup="from __main__ import factorial", number=1000))
