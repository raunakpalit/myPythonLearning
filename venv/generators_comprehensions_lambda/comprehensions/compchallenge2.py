...
# The list should contain the description of each location, if it is possible to get to the forest from there.
#
...
#
# Once it is working, modify the program so that the comprehension returns a list of tuples.
...
for loc in sorted(locations):
    ...
    print("Locations lead to {}".format(loc), end='\t')
    print(forest)