...
class Album:
    ...
    Attributes:
        ...
        year (int): The year when album was released.
...
class Artist:
    ...
    def add_song(self, name, year, title):
        ...
        A new album will be created in the collection if it doesn't alreay exist.
...
def load_data():
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            ...
            #     # retrieve the atist object if there is one,
        ...
        # # After read the last line of the text file, we will have an artist and album that have not
